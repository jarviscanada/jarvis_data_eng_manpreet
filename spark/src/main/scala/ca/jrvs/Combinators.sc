...
val countResult = ls.count(x => {x % 1 == 0})
println(countResult)
...
val res1 = numList.flatMap(x => x.map(_+1))
...
countryMap.get("Amy")
countryMap.get("manpreet")
countryMap.getOrElse("manpreet", "n/a")
 ...
 */
val employeeData = File("/home/centos/dev/jarvis_data_eng_manpreet_kaur/spark/src/main/resources/employees.csv")
