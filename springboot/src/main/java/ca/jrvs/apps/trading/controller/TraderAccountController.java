...
public class TraderAccountController {
    ...
    @ApiOperation(value = "Delete a trader",
            notes = "Delete a trader iff it's account balance is 0 and no associated open positions."
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 400, message = "Unable to deposit due to input format.")})
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    ...
    @ApiOperation(value = "Withdraw a fund",
            notes = "Withdraw fund from the account that associates with the given traderId.")
    @ApiResponses(value = {
            @ApiResponse(code = 404, message = "TraderId is not found."),
